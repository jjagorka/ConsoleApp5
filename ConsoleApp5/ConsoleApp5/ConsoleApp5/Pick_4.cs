...
namespace ConsoleApp5
{
    public class Pick_4 : Task
    {
        ...
        {
            string string1 = IOUtils.SafeReadString("Введите первую строку: ");
            string string2 = IOUtils.SafeReadString("Введите вторую строку: ");
        ...
        static string Coincidence_1(List<string>strings, ISpecification<List<string>> specification = null)
        {
            try
            {
        ...
        static string IsValidEmail(string str, ISpecification<string> specification = null)
        {
            try
            {
                if (specification != null)
        ...
        static string IsValidPhoneNumber(string str, ISpecification<string> specification = null)
        {
            try
            {
                if (specification != null)
        ...
        static string IsValidIP(string str, ISpecification<string> specification = null)
        {
            try
            {
                if (specification != null)
